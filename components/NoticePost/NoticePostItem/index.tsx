...
export const NoticePostItem = ({ created_at, name, title, content }: Props) => {
  let isAdmin;
    ...
    <div>
      ...
      >
        <div className="w-full flex justify-between">
          ...
          {isAdmin ? <button className="w-[70px] h-[30px] bg-[#FF8080] text-[#F5F5F5] cursor-pointer">삭제</button> : null}
        </div>
